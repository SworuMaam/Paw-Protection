...
(
  'Whiskers', 'Cat', 'Maine Coon', 2, 'Male', 'Large',
  ARRAY['Calm', 'Affectionate', 'Independent'], 'Moderate', 'Good',
  ARRAY['Indoor only', 'Regular grooming'],
  'Whiskers is a gentle giant who loves cuddling and watching birds from the window.',
  ARRAY['https://images.pexels.com/photos/45201/kitty-cat-kitten-pet-45201.jpeg'],
  'Portland, OR', ARRAY['Urban', 'Suburban', 'Rural'],
  'Premium wet and dry food', 'Three times daily',
  ARRAY['Feather wands', 'Catnip mice', 'Scratching posts'],
  '{"indoor": "Medium apartment or larger"}',
  '{"children": true, "otherPets": true, "apartments": true}',
  150
),
(
  'Buddy', 'Dog', 'Mixed Breed', 5, 'Male', 'Medium',
  ARRAY['Gentle', 'Loyal', 'Calm'], 'Moderate', 'Good',
  ARRAY['Patient family', 'No small children'],
  'Buddy is a sweet senior dog looking for a quiet home to spend his golden years.',
  ARRAY['https://images.pexels.com/photos/1254140/pexels-photo-1254140.jpeg'],
  'Austin, TX', ARRAY['Urban', 'Suburban'],
  'Senior dog formula', 'Twice daily',
  ARRAY['Soft chew toys', 'Comfort blankets'],
  '{"indoor": "Small to medium space", "outdoor": "Small yard or regular walks"}',
  '{"children": false, "otherPets": true, "apartments": true}',
  100
);